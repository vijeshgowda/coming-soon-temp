...
const translations = {
  ...
  en: {
    ...
    'lobby.copied': 'Copied!',
    'lobby.code_changes_1': 'If the code changes after sharing, use your copied code to join the room',
  ...
  es: {
    ...
    'lobby.code_changes_1': 'Si el código cambia tras compartirlo, usa el código que copiaste para entrar a la sala',
  ...
  fr: {
    ...
    'lobby.copied': 'Copié !',
    'lobby.code_changes_1': 'Si le code change après le partage, utilisez le code copié pour rejoindre le salon',
  ...
  de: {
    ...
    'lobby.code_changes_1': 'Falls sich der Code nach dem Teilen ändert, nutze den kopierten Code, um dem Raum beizutreten',
  ...
  hi: {
    ...
    'lobby.code_changes_1': 'अगर साझा करने के बाद कोड बदल जाए, तो जुड़ने के लिए अपना कॉपी किया कोड इस्तेमाल करें',
